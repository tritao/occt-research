...
int main()
{
  ...
  EmitCase(std::cout, "single_edge_radius_1", box, singleEdge, 1.0, false);
  EmitCase(std::cout, "corner_3_edges_radius_1", box, cornerEdges, 1.0, false);
  EmitCase(std::cout, "single_edge_radius_100", box, singleEdge, 100.0, true);
