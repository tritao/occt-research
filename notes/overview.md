...
| `fillets` ([hub](maps/hub-fillets.md)) | edge blending operations (fillet/chamfer) and the fillet builder pipeline for solids/shells. | `notes/maps/lane-fillets.md` | `notes/dossiers/lane-fillets.md` | `repros/lane-fillets/README.md` | Done (4) |
