...
def copy_file(src: Path, dst: Path, *, tmp_root: Path, src_rel: str) -> None:
...
def copy_glob(root: Path, pattern: str, dest_root: Path, *, tmp_root: Path) -> int:
    ...
    for src in sorted(root.glob(pattern)):
        ...
        copy_file(src, dest_root / rel, tmp_root=tmp_root, src_rel=str(rel))
        count += 1
    return count
...
def main() -> int:
    ...
    copy_file(overview_src, overview_dst, tmp_root=tmp_root, src_rel="overview.md")
