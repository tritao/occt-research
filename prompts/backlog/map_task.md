...
2) Identify which existing generators apply:
   ...
   - use `notes/maps/_template_lane.md` as the lane-map outline (recommended)
3) Produce the requested artifact(s) in `notes/maps/`:
   ...
   - Ensure provenance exists: `notes/maps/provenance.md` (generated by `just maps`; required for future dossiers)
...
- [ ] `notes/maps/provenance.md` exists/updated
